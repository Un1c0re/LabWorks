...
/* Вывод каталога звёзд */
/*void print(Star arr[], int n) {
   int i;
...
/* ШАГ 3 - ГЛАВНАЯ ФУНКЦИЯ: Реализация интерактивного интерфейса */
   ...
   do {
      ...
      switch (key) {
         ...
         case 3: /*Найти звёзду по её звёздной величине */
            ...
            /* Введите диапазон звёздной величины */
            scanf("%lg%lg", &a, &b);
